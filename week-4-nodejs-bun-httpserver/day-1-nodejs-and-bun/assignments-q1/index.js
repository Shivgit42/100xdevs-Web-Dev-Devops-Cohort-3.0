...
program
  ...
  .description("CLI to do file based tasks") //description of program likke woh krta kya hai
  .version("0.8.0"); //version of the program

program
  .command("count") //yeh program bnaye hai jo..count command bnaye hai jo number of words ko count krta hai
  ...
  .action((file) => {
    //ab yeh uska action ki like woh count command execute hua toh karna kya hai
